...
const Slider = () => {
    return (
        <View style={sliderTheme.sliderContainer}>
            <Swiper alwaysBounceVertical horizontal={false} overScrollMode='never' bounces={true} autoplayTimeout={5} activeDotColor={colours.primaryColor} showsPagination={true} loop autoplay height={height / 4}>
