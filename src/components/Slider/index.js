...
const Slider = () => {
    return (
        <View style={sliderTheme.sliderContainer}>
            <Swiper bounces={true} autoplayTimeout={5} activeDotColor={colours.primaryColor} showsPagination={true} loop autoplay height={height / 4}>
                <TouchableOpacity style={sliderTheme.slider}>
